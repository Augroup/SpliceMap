...
echo "Builds the (32-bit) SpliceMap package [including Barloader] and copies executables to output_directory and overwrites the old files"
exit 1
fi

cd SpliceMap-src

echo ">>> Building the (32-bit) SpliceMap package..."
...
echo ">>> Building the (32-bit) Barloader..."

g++ -m32 -O3 -o barloader *.cpp
